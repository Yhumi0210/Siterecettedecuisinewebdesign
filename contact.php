    ...
    <div class="pattern">
        <header class="main-nav">
            ...
            <ul class="nav navbar">
                    ...
                    <li class="rond"><a class="nav-link active bouncing-element" href="https://yhumisunstra.com/contact.php">Contact</a></li>
                </ul>
            </nav>
        </header>
        ...
        <section class="search">
            <div class="rectangle-menu">
                ...
                <div class="rectangle-rose">
                    <h2>Vous avez des suggestions ?<br>
                        Faites le nous savoir !</h2>
                </div>
                <div>
                    <form action="send-email.php" method="POST">
                        <label for="name">Nom :</label>
                        <input class="form-size" type="text" id="name" name="name" required>

                        <label for="email">Email :</label>
                        <input class="form-size" type="email" id="email" name="email" required>

                        <label for="message">Message :</label>
                        <textarea class="form-size-mess" id="message" name="message" rows="4" required></textarea>

                        <input class="button-connect-contact bouncing-element2" type="submit" value="Envoyer">
                    </form>
                </div>
            </div>
        </section>
